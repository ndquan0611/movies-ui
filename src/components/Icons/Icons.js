...
export const VolumeIcon = ({ width = '4rem', height = '4rem', className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="currentColor"
        width={width}
...
export const UnVolumeIcon = ({ width = '4rem', height = '4rem', className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="currentColor"
        width={width}
...
export const RightIcon = ({ width = '5rem', height = '5rem', className }) => (
    <svg
        stroke="currentColor"
        fill="none"
        strokeWidth={2}
...
export const LeftIcon = ({ width = '5rem', height = '5rem', className }) => (
    <svg
        stroke="currentColor"
        fill="none"
        strokeWidth={2}
